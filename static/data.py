SPECIALS = [
    ...
    {"name": "Arcane Magic",
     "description": "PC may use ANY magic spell according to the Magic rules (see Magic section)."},
    ...
    {"name": "Brawler",
     "description": "PC does 1d6 Damage (as a Medium Weapon) when fighting unarmed or using improvised weapons."},
    {"name": "Burrower",
    ...
    {"name": "Nature Magic",
     "description": "PC may use Nature Magic spells according to the Magic rules (see Magic section)."},
    {"name": "Night Vision",
